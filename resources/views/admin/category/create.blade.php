...
@section('content')
    ...
    <form action="{{ route('admin.category.store') }}" method="post" enctype="multipart/form-data" class="relative w-full p-4">
        @csrf
        <div class="mb-8">
            ...
            <input type="text" name="name" id="name" value="{{ old('name') }}" placeholder="your category..."
