...
@section('content')
    <div class="relative overflow-x-auto sm:rounded-lg ">
        <div class="p-4 text-2xl font-bold uppercase text-gray-900">
            ...
            <a href="{{ route('member.menu.create') }}">
            ...
            <table class="w-full text-sm text-left text-gray-500 p-3">
                ...
                @foreach ($menus as $i => $menu)
                    <tr class="bg-white border-b">
                        ...
                        <td class="px-6 py-4">
                            <x-button-detail :url="route('member.menu.show', $menu->id)" />
                            <x-button-edit :url="route('member.menu.edit', $menu->id)" />
                            <x-button-delete :id="$menu->id" :url="route('member.menu.destroy', $menu->id)" />
                        </td>
                    </tr>
                @endforeach
                </tbody>
