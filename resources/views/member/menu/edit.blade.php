...
@section('content')
    ...
    <form action="{{ route('member.menu.update', $menu->id ) }}" method="post" enctype="multipart/form-data" class="relative w-full p-4">
        @csrf
        @method('PUT')
        <div class="mb-5">
        ...
        <div class="mb-5">
            ...
            <input type="text" name="name" id="name" value="{{ $menu->name }}" placeholder="your menu..."
                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5
                    focus:outline-none focus:ring-1 focus:ring-emerald-800 focus:border-emerald-800  placeholder:text-slate-400
        ...
        <div class="mb-5">
            ...
            <input type="text" name="price" id="price" value="{{ $menu->price }}" placeholder="your price..."
                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5
                    focus:outline-none focus:ring-1 focus:ring-emerald-800 focus:border-emerald-800  placeholder:text-slate-400
