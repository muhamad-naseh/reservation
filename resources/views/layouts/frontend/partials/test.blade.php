<div class="w-full bg-emerald-900 p-3 border-b border-slate-700 border-dashed">
    <div class="container mx-auto">
        <div class="flex items-center justify-between">
            <!-- NavMenu -->
            <ul class="flex items-center justify-center gap-6">
                <li>
                    <a href="/" class="flex items-center text-xl text-white font-semibold">
                        <svg  xmlns="http://www.w3.org/2000/svg"  width="30"  height="30"  viewBox="0 0 24 24"  fill="none"
                              stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"
                              class="icon icon-tabler icons-tabler-outline icon-tabler-christmas-tree mr-2">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                            <path d="M12 3l4 4l-2 1l4 p4l-3 1l4 4h-14l4 -4l-3 -1l4 -4l-2 -1z" />
                ...
                <li class="hidden lg:flex">
                    <a href="{{ route('menu.index') }}"
                       class="text-sm font-semibold text-white flex items-center gap-2 {{ activeNav('menu.index') }}">
            ...
            <div class="hidden md:flex items-center gap-2 text-white">
                @guest
                    <a href="{{ route('login') }}"
                       class="text-gray-200 font-semibold flex items-center border px-4 py-2 gap-2 rounded-lg text-xs bg-emerald-800 border-gray-200">
                    ...
                    <a href="{{ route('register') }}"
                       class="font-semibold text-white flex items-center border px-4 py-2 gap-2 rounded-lg text-xs bg-emerald-800 border-gray-200">
            ...
            <div class="flex gap-1 items-center md:hidden">
                ...
                <div class="text-white relative" x-data="{ isOpen: false }">
                    ...
                    <ul x-cloak x-show="isOpen" @click.away="isOpen = false"
                        ...
                        <li>
                            <a href="{{ route('menu.index') }}"
                               class="p-3 rounded-lg text-sm font-semibold text-white flex items-center gap-2 hover:text-blue-500 {{ activeNav('menu*') }}">
                                <svg xmlns="http://www.w3.org/2000/svg"
